...
def upgrade() -> None:
    ...
    op.create_index('ix_resourceargument_resource_type', 'resourceargument', ['resource_type'])
    ...
    op.create_index('ix_ansiblecollection_namespace', 'ansiblecollection', ['namespace'])
    ...
    op.create_index('ix_moduleparameter_module_name', 'moduleparameter', ['module_name'])
